...
public class GaussianSleeper extends CalAmpSIStage {
    ...
    public GaussianSleeper(String ident, Boolean isFinalStage, Double mu,
            Double sigma) {
    ...
    public CalAmpSIWrapper enact(CalAmpSIWrapper inPayload)
        ...
        Integer myDelay = (int) Math.round(this.rand.nextGaussian()
                * this.sigma + this.mu);
        Thread.sleep(myDelay);
        String dataAsString = inPayload.getDataAsString()
