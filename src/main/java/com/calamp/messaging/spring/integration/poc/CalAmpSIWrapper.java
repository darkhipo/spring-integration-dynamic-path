...
public class CalAmpSIWrapper {
    ...
    public CalAmpSIWrapper(CalAmpSIWrapper copyMe) {
        ...
        this.transitPath = CalAmpSIWrapper.copyStringList(copyMe
                .getTransitPath());
        this.futurePath = CalAmpSIWrapper
                .copyStringList(copyMe.getFuturePath());
    ...
    public String toString() {
        if (this.wrappedException == null) {
            return "CalAmpSIWrapper [siIdent=" + siIdent + ", transitPath="
                    + transitPath + ", futurePath=" + futurePath
